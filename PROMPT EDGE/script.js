...
const Api_Url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyBejoPxiKa6TWBKIS4SOnsNSy3tInSCCYE";
...
async function generateResponse(aiChatBox) {
    ...
    try {
        ...
        console.log(error);
        text.innerHTML = "⚠️ Error while fetching response.";
    } finally {
